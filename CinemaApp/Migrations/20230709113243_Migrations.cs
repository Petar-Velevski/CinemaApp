    ...
    public partial class Migrations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoppingCartDtos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShoppingCartDtoId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketsInShoppingCart", x => new { x.TicketId, x.ShoppingCartId });
                    table.ForeignKey(
                        name: "FK_TicketsInShoppingCart_ShoppingCartDtos_ShoppingCartDtoId",
                        column: x => x.ShoppingCartDtoId,
                        principalTable: "ShoppingCartDtos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketsInShoppingCart_ShoppingCartDtoId",
